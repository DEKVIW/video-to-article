...
class ToolsPage(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.raw_edit.setPlaceholderText("选择已有的 raw.md")
        b1 = QPushButton("浏览…")
        ...
        fr.addLayout(pair)
        tip = QLabel("不重新下载与转写，仅根据已有 raw 补写文章；适合大模型中断后继续。")
        ...
        self.article_edit.setPlaceholderText("选择文章 Markdown 文件")
        b2 = QPushButton("浏览…")
        ...
        self.thumb_edit.setPlaceholderText("可选参考图")
        b3 = QPushButton("浏览…")
        ...
        self.report_edit.setPlaceholderText("选择批量报告 JSON 文件")
        b4 = QPushButton("浏览…")
        ...
        self.yt_url_edit.setPlaceholderText("可选：填视频链接以实测能否访问")
        ...
        self.refresh_out.setPlaceholderText("留空则使用默认 cookies 文件")
